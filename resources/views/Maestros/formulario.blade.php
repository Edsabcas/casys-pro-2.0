                 ...
                 {{-- TITULO DE NIVEL MEDIO --}}
                  ...
                  <div class="container">
                    <div class="row"> 
                      <div class="col">
                        <div class="mb-3">
                          <label for="exampleInputEmail1" class="form-label">No. de Cedula Docente:</label>
                 ...
                 {{-- OTROS ESTUDIOS --}}
                        ...
                        @error('otros_estudios') 
                          <div class="alert alert-danger d-flex align-items-center" role="alert">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-exclamation-triangle-fill flex-shrink-0 me-2" viewBox="0 0 16 16" role="img" aria-label="Warning:">
                              ...
                              <span>¡Pendiente el ingresar!</span>
                          </div> 
                        @enderror
                  ...
                  <div class="container">
                    <div class="row"> 
                      ...
                      <div class="col">
                        <div class="mb-3">
                          <label for="exampleInputEmail1" class="form-label">Cursos aprovados:</label>

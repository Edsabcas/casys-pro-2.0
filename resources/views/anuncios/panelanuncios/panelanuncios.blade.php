    ...
    <tbody>
      ...
      <tr>
        ...
        @if($anuncio->CALIDAD_ANUNCIO==1)
            ...
            @endif
            <td>
                <button class="btn btn-editb" data-bs-toggle="modal" data-bs-target="#infodata7"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                  ...
                  <button type="button" wire:click='id_a_eliminar({{$anuncio->ID_ANUNCIOS}})' id="Crear" class="btn btn-secondary" style="border-radius: 12px;">
                  ...
                  <button  class="btn btn-danger"  data-bs-toggle="modal" data-bs-target="#eliminaranuncio{{$anuncio->ID_ANUNCIOS}}">Eliminar</button>

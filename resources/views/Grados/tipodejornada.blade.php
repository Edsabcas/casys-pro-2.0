...
@endisset
<p>
  <h4 class="text-center">Crear Jornada</h4>
</p>
<form wire:submit.prevent="">
    ...
    <div class="container">
      <div class="row">
        <div class="col">
          <div class="mb-3">
              <label for="floatingInput">Ingresar Jornada:</label>
    ...
    @error('estado_jornada') 
      <div class="alert alert-danger d-flex align-items-center" role="alert">
        ...
        <span>Pendiente la selección del estado</span>
         </div> 
         @enderror
    @if ($edit!=null)
    <button class="btn btn-success" wire:click="update_jornada_p()">Editar</button>
    @else
    <button class="btn btn-primary" wire:click="guardar_jornada()">Agregar</button>  
    @endif
</form>
  ...
  <div wire:ignore.self class="modal fade" id="exampleModaledit1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="5" aria-labelledby="exampleModaledit1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <h2 class="modal-title">Ingrese los datos para crear un tema</h2>
          <button type="button" class="btn-close"  id="Editaract" aria-label="Close" data-bs-dismiss="modal"></button >
        </div>
              ...
              <form wire:submit.prevent=''>
                ...
                <div class="row g-3">
                  <div class="col-sm-3">
                    ...
                    <button type="submit" class="btn btn-pre2" wire:click="Subir_Tema()"  id="Editaract"  data-bs-dismiss="modal" >Publicar</button>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" aria-label="Close"  id="Editaract"  data-bs-dismiss="modal" >Cerrar</button>

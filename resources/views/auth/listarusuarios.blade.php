      ...
      @foreach ($listadousers as $listadouser)
        <tr>
            ...
            <td>
              ...
              @else
              <img class="img-profile rounded-circle" width="40" height="40" src="imagen/perfil/{{$listadouser->img_users}}" />
              <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#perfilmodal2">

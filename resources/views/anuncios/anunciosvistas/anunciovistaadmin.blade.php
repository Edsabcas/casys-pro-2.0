          ...
          <div class="card-body">
            ...
            <div class="alert alert-success d-flex align-items-center rounded-pill" role="alert">
              ...
              <div class="container">
                ...
                @if($anuncio->ID_ANUNCIOS == $gustaa->ID_PUBLICACION && $gustaa->ID_USUARIO == auth()->user()->id && $gustaa->ESTADO == 1 && $cambiolike == 1)
                
                <button style="border:0px" type="button" class="btn btn-primary" wire:click="megusta({{$anuncio->ID_ANUNCIOS}})" style="margin: 10px"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up-fill" viewBox="0 0 16 16">

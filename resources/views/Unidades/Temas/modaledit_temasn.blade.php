<div wire:ignore.self class="modal fade" id="deletetema_n" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="5" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="container-sm">
              ...
              <form action="/update_temas2" method="POST">
                @csrf
                ...
                <div class="row g-3">
                  <div class="col-sm-3">
                    ...
                    <input type="text" class="form-control" name='tema2'  style="border:2px solid rgba(86, 95, 76, 0.466);" placeholder="Titulo de la actividad" aria-label="Titulo de la actividad">
                    @error('tema2') 
                    ...
                    <div class="col-sm-10">
                      ...
                      <textarea type="text" class="form-control" name='descripciont2'  style="border:2px solid rgba(128, 156, 96, 0.466);" id="exampleFormControlTextarea1" rows="3"></textarea>
                      @error('descripciont2') 
                    <div class="alert alert-danger d-flex align-items-center" role="alert">
                      <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Success:"><use xlink:href="#check-circle-fill"/></svg>

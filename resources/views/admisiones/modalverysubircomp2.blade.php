  ...
  <div  wire:ignore.self class="modal fade" id="visualizarimagen2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="visualizarimagenLabel" aria-hidden="true">
    <div class="modal-lg modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" class="btn-close"  data-bs-dismiss="modal" id="info4" aria-label="Close"></button>
        </div>
  ...
  <div wire:ignore.self class="modal fade" id="subirimagen2" tabindex="-1" aria-labelledby="perfilmodal2Label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <button class="btn btn-danger" data-bs-dismiss="modal" id="info4">Cerrar</button>
          <button class="btn btn-pre2" wire:click="cambiofoto()" data-bs-dismiss="modal" id="info4">Publicar</button>
        </form>
        </div>
      </div>
    </div>

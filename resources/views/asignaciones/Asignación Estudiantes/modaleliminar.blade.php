    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropLabel">ELIMINAR DATOS DE ASIGNACIÓN ESTUDIANTES</h5>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-dark" wire:click='delete({{$est->ID_E}})' data-bs-dismiss="modal">Eliminar Datos</button>
        </div>
      </div>
    </div>
  </div>
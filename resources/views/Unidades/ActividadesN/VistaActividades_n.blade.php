...
<div class="card border-primary mb-3" style="max-width: 70rem;" >
 ...
 <div class="accordion accordion-flush" id="accordion{{$actividad->ID_ACTIVIDADES}}">
  ...
  <button class="btn btn-success"  id="val" data-bs-toggle="modal" data-bs-target="#editaractividades2"   wire:click='edita2({{$actividad->ID_ACTIVIDADES}})'> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
  ...
  <button class="btn btn-secondary" style="border-radius: 12px;" data-bs-toggle="modal" data-bs-target="#eliminar_n"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">

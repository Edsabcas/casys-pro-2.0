            ...
            <tbody>
                @foreach ($roles as $rol)
                    <tr>
                        ...
                        <td>
                          <span>
                            <button type="button" wire:click='cargarmenu({{$rol->ID_ROL}})' class="btn btn-pre2" data-bs-toggle="modal" data-bs-target="#exampleModal1">
                              Administar Menú
                            </button>
                          </span>  
                        </td>
    ...
    <button type="button" {{-- wire:click='guardar_rol()' --}} class="btn btn-pre2" data-bs-toggle="modal" data-bs-target="#exampleModal">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
              <div class="modal-header text-center" style="background:#a4cb39;color:rgb(255, 255, 255)">
                <h3 class="modal-title text-center" id="exampleModalLabel" style="color:rgb(255, 255, 255)" >Agregar Nuevo Rol</h3>
                ...
                <form>
                    ...
                    @error('rol') 
                      <div class="alert alert-danger d-flex align-items-center" role="alert">
                        <svg class="bi flex-shrink-0 me-2" width="12" height="12" role="img" aria-label="editb"><use xlink:href="#check-circle-fill"/></svg>
            ...
            <div class="modal-footer">
                @if ($edit!=null)
                    <button class="btn btn-pre2" wire:click="update_rol_p()"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                        <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                        <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                        </svg>
                    </button>
      ...
      <div wire:ignore.self class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header text-center" style="background:#a4cb39;color:rgb(255, 255, 255)">
              <h3 class="modal-title text-center" style="color:rgb(255, 255, 255)" ><strong>Menú de roles</strong></h3>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <p class="fs-6 fw-bold">Seleccionar las casillas para la creación del menú:</p>
                ...
                <div class="row">
                  @if (Session::get('opciones')!=null)
                    ...
                    @else
                      <div class="col-sm">
                        <div class="form-check form-switch">
                          <input class="form-check-input" value="1" type="checkbox" role="switch" checked>
                          <label class="form-check-label" for="flexSwitchCheckDefault">{{$opcion->DESCRIPCION}}</label>
                        </div>
                      </div> 
                    @endif

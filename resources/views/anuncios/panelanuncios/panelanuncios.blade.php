        ...
        @if($anuncio->CALIDAD_ANUNCIO==1)
            ...
            @endif
              ...
              <td>
                ...
                <button class="btn btn-editb" wire:click='editar_anuncio({{$anuncio->ID_ANUNCIOS}})' data-bs-toggle="modal" data-bs-target="#editaranuncio"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                ...
                <button class="btn btn-secondary"  style="border-radius: 12px;" wire:click='id_a_eliminar({{$anuncio->ID_ANUNCIOS}})' data-bs-toggle="modal" data-bs-target="#eliminaranuncio"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">

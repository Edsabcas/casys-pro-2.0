      ...
      <div class="col-xl-4 col-sm-7 col-13 mb-5">
        <div class="card">
          <div class="card-body">
            ...
            <a wire:click='mostrar_u("{{$materia->ID_MATERIA}}","{{$materia->NOMBRE_MATERIA}}","1")' class="btn btn-currentColor fw-bold" style="background-color:#a4cb39; color:white">Temas</a>
          </div>
        </div>
      </div>
      @endif

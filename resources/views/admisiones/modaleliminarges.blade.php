<div  wire:ignore.self class="modal fade" id="exampleModal{{$estado_cer->ID_PRE}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">

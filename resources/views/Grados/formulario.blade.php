    ...
    <div class="row">
      ...
      <div class="col">  
        ...
        <div class="input-group">
          <button class="btn btn-outline-pre2" data-bs-toggle="modal" data-bs-target="#staticBackdrop" type="button"><img src="https://img.icons8.com/material-two-tone/24/000000/add.png"/></button>
...
@endisset
  ...
  <div class="container"> 
    ...
    @if ($edit!=null)
      <button class="btn btn-editb" wire:click="update_gr_p()"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">

...
<div class="card border-primary mb-3" style="max-width: 70rem;" >
 ...
 <div class="accordion accordion-flush" id="accordion{{$tema->ID_TEMA}}">
  ...
  <button class="btn btn-editb"  data-bs-toggle="modal" data-bs-target="#tema_n" wire:click='editt2({{$tema->ID_TEMA}})'> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
  ...
  <button class="btn btn-secondary" Style="border-radius: 12px;" data-bs-toggle="modal" data-bs-target="#deletetema_n{{$tema->ID_TEMA}}"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">

...
<div class="alert alert-success alert-dismissible fade show" role="alert">
  ...
  @elseif($mensaje_eliminacion!=null)
  <div class="alert alert-success alert-dismissible fade show" role="alert">
    ...
    <tbody>
      ...
      <tr>
        ...
        @if($anuncio->CALIDAD_ANUNCIO==1)
            ...
            <span>
              <td>
                <a href="/panel_editar_anuncios" wire:click='editar_anuncio({{$anuncio->ID_ANUNCIOS}})' class="btn btn-editb" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
